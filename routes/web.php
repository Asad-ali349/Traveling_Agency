...
Route::controller(AdminController::class)->group(function (){
    ...
    Route::get('/admin/view_customer','view_customer')->name('customer_list');
    ...
    Route::get('/admin/view_group','view_group')->name('grouping_list');
    ...
    Route::get('/admin/view_reservations','view_reservations')->name('reservation_list');
    ...
    Route::post('/admin/compta_accounting','filter_compta_accounting');
    ...
    Route::get('/admin/view_ticking_history','view_ticking_history')->name('view_ticking_history');
